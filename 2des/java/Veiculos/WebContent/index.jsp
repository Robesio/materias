<%@page import="controll.ProcessaVeiculo"%>
...
<body>
	<form method="POST">
		<input type="text" size="12" name="placa" placeholder="PLACA" />
		<input type="text" size="12" name="marca" placeholder="MARCA" />
		<input type="text" size="12" name="modelo" placeholder="MODELO" /></br></br>
		<input type="text" size="12" name="ano" placeholder="ANO" />
		<input type="text" size="12" name="km" placeholder="KM" />
