...
public class impar_par extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("ingressar valor inicial");

        jLabel2.setText("ingressar valor final");
        ...
        btnpares.setText("mostrar numeros impares");
        ...
        btnimpares.setText("mostrar numeros pares");
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        .addComponent(txtinicio, javax.swing.GroupLayout.DEFAULT_SIZE, 72, Short.MAX_VALUE)
                        .addComponent(txtfin))
    ...
    private void btnimparesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnimparesActionPerformed
        // TODO add your handling code here:
        limpar();
        int inicio=Integer.parseInt(txtinicio.getText().toString());
        int fin=Integer.parseInt(txtfin.getText().toString());
        
        for (int i = inicio; i <= fin; i++) {
            if (i%2==0) {
                txtmostrar.append(String.valueOf(i+"\n"));
            }
        }
